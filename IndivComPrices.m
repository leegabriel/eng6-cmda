...
% Last Modified by GUIDE v2.5 09-Mar-2015 18:35:27
...
% --- Executes on button press in pushbutton53Zinc_PushButton.
function pushbutton53Zinc_PushButton_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton53Zinc_PushButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
